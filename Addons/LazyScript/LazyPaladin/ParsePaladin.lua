...
function lazyPaladinLoad.LoadParsePaladin()
	...
	lazyPaladin.actions.crusaderStrike  = lazyPaladin.Action:New("crusaderStrike",      "Spell_Holy_CrusaderStrike", nil, nil, true)
	...
	lazyPaladin.actions.hmrJustice      = lazyPaladin.Action:New("hmrJustice",          "Spell_Holy_SealOfMight")
	...
	lazyPaladin.actions.hof             = lazyPaladin.Action:New("hof",                 "Spell_Holy_SealOfValor")
	lazyPaladin.actions.hop             = lazyPaladin.Action:New("hop",                 "Spell_Holy_SealOfProtection")
	lazyPaladin.actions.hor             = lazyPaladin.Action:New("hor",                 "Spell_Holy_Redemption")
	lazyPaladin.actions.hos             = lazyPaladin.Action:New("hos",                 "Spell_Holy_SealOfSacrifice")
	...
	lazyPaladin.actions.sealRight       = lazyPaladin.Action:New("sealRight",           "Ability_ThunderBolt", nil, nil, true)
	...
	lazyPaladin.actions.zybl            = lazyPaladin.Action:New("zybl",                "Ability_Warrior_VictoryRush")
	lazyPaladin.actions.ch              = lazyPaladin.Action:New("ch",                  "Spell_Holy_AuraMastery")
	...
	function lazyScript.bitParsers.ifSwinged(bit, actions, masks)
		...
		table.insert(masks, lazyScript.negWrapper(lazyPaladin.masks.isSwinged, negate))
		return true
	end
